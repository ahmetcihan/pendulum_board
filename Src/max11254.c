...
/*																					*/
/*	[ !! ] Press Cihazn�n TMS700 diger cihazlar�ndan farkl�							*/
/*		   ( - ) 4 kanal ADC vardir.												*/
...
/* 					olarak yap�land�rmal�											*/
/*																					*/
/*		   ( - ) ���nc� ve d�rd�nc� kanalda ki  ADClerden LVDT okunacaktir.			*/
...
/**
  ...
  * @param  command   : max11254.h COMMAND_ ile baslayan Rate ve Mode se�imleri & islemi ile girilebi   
  */
...
/**
  * @brief  MAX11254'�n 'Adr' registir adresine 8 bitlik 'Data' degerini yazar.
...
/**
  * @brief  MAX11254'�n 'Adr' registir adresine 16 bitlik 'Data' degerini yazar
  * @param  Adr      	: Max11254 register adres  
...
/**
  * @brief  MAX11254'�n 'Adr' registir adresine 24 bitlik 'Data' degerini yazar
  * @param  Adr      	: Max11254 register adres
...
/**
  * @brief  MAX11254'�n 'Adr' registir adresinden 8 bitlik data okur 
...
/**
  * @brief  MAX11254'�n 'Adr' registir adresinden 16 bitlik data okur   
...
/**
  * @brief MAX11254'�n 'Adr' registir adresinden 24 bitlik data okur  
...
/**
  * @brief  MAX11254'�n RSTB pinini Low dan High'a �ekerek donanimsal resetler 
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief  MAX11254'� CTRL1 registeri �zerinden yazilimsal resetler
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief 	Max11254'� Self Kalibre yapar.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief 	Max11254'� System Offset Kalibresi yapar.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief 	Max11254'� System Full Scacale Kalibresi yapar.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief 	Max11254'� System Kalibresi yapar.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
 * @brief  Max11254'�n anolog input sinyalini girilen deger kadar g�clendirir.
...
/**
  * @brief  Max11254'�n dahili 6 kanalindan conversiyon islemine tabi tutulacak kanali se�er
...
/**
  * @brief  Max11254'� Sequencer Mode 1 de yapilandirir.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief  Max11254'� Sequencer Mode 2 de yapilandirir.  
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief  Max11254'� Sequencer Mode 3 de yapilandirir.
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief  Max11254'� Sequencer Mode 1 de yapilandirmasi iptal edilir.
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**
  * @brief  Max11254'� Sequencer Mode 2 de yapilandirmasi iptal edilir.
  * @param  [ void ] 
  * @retval [ void ]
  */ 
...
/**
  * @brief  Max11254'�n baslangic yapilandirilmasi yapar.
  * @param  [ void ] 
  * @retval [ void ]
  */
...
/**	Klasik Moving Average Filtresi Fonksiyonlari 
  ...
  * @param  raw_signal	  			: MovingAverage Filtresine g�nderilecek raw data 
	* @param  filter_coefficient	: Filtre katsayisi
	* @note   static double running_averange dizisi eleman sayisi filter_coefficient degerinden k���k olmamali 
  *          This parameter can be one of the following values:
  * @retval 
  */
/*
